...
secret_key = get_secret(os.getenv("FLASK_CAFE_SECRET_NAME", "jordan-cafev5/flask_secret"), region_name=os.getenv("AWS_REGION", "us-east-1"))
...
email_secrets = get_secret(os.getenv("EMAIL_SECRET_NAME", "jordan-cafev5/emailcreds"), region_name=os.getenv("AWS_REGION", "us-east-1"))
...
db_secrets = get_secret(os.getenv("DB_SECRET_NAME", "jordan-cafev5/db_creds"), region_name=os.getenv("AWS_REGION", "us-east-1"))
